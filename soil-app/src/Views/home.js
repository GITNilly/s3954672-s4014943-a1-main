  ...
  return (
    <div>
      ...
      <div className="homepage-background">
        ...
        <div className="home-growYourGardenInfo">
          ...
          <h2>Watering</h2>
          <p>
            Water plants regularly, focusing on the roots rather than the
            foliage.
          </p>
          <p>
          ...
          <h2>Mulching</h2>
          <p>
            Apply mulch around your plants to retain moisture, suppress weeds,
          ...
          <h2>Harvesting</h2>
          <p>
            Harvest vegetables at their peak for the best flavor and to
          ...
          <p>
            You've gotten to the final, and most important step of them all.
            Enjoy the process. Whilst gardening for a first timer can be
            daunting, as you build experience it will become second nature to
            you!
            <br></br>
            Saving money by growing your own vegetables or fruits in your
            backyard can be a great rewarding feeling. So go out there, and give
            it your best shot!
          </p>
        </div>
      </div>
